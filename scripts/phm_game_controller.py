...
class TigTagToe(object):
    ...
    def __init__(self):
        ...
        self.LeftSlotsLocation = [ [0.3951-0.005, 0.2694+0.003, -0.0749+0.005, 0.0147, 0.9999, -0.0085, -0.0051], \
                                    [0.5089-0.010, 0.2679+0.01, -0.0734, -0.0001, 0.9996, -0.0093, -0.0243], \
                                    [0.6177-0.005, 0.2716+0.005, -0.0753-0.004, 0.0166, 0.9995, -0.0033, -0.0266], \
                                    [0.5031, 0.3795+0.005, -0.0745, 0.0153, 0.9998, -0.0091, -0.0435], \
                                    [0.6150-0.005, 0.3809, -0.0763, 0.0033, 0.9998, 0.0030, -0.0086] ]
        
        self.RightSlotsLocation = [ [0.4040, -0.2569-0.003, -0.0756, -0.0206, 0.9997, 0.0018, 0.0164], \
                                    [0.5131, -0.2545, -0.0737, -0.0057, 0.9998, 0.0029, 0.0198], \
                                    [0.6174+0.01, -0.2559+0.005, -0.0784, -0.0179, 0.9996, -0.0142, -0.0104], \
                                    [0.5224, -0.3682, -0.0716, -0.0186, 0.9997, 0.0058, -0.0127], \
                                    [0.6285+0.005, -0.3660, -0.0699, 0.0031, 0.9998, 0.0031, 0.0191] ]
        
        self.GridForLeftArm = [ [0.3965+0.020, -0.1069-0.02, -0.0736, 0.03617, 0.9991, -0.0098, -0.0198], \
                                [0.5040+0.005, -0.1058+0.005, -0.0775, 0.0147, 0.9994, 0.0002, -0.0316], \
                                [0.6115-0.005, -0.0908-0.005, -0.0875, 0.0146, 0.9999, 0.0064, -0.0047], \
                                [0.3917, 0.0117+0.002, -0.0796, 0.0073, 0.9993, 0.0042, -0.0364], \
                                [0.4983+0.01, 0.0108+0.005, -0.0821, -0.0066, 0.9999, 0.0015, -0.0127], \
                                [0.6093, 0.0097, -0.0855+0.005, 0.0154, 0.9997, 0.0029, -0.0194], \
                                [0.3914-0.01, 0.1200, -0.0779, 0.0126, 0.9994, -0.0002, -0.0333], \
                                [0.5029, 0.1203, -0.0811+0.005, 0.0020, 0.9993, 0.0008, -0.0378], \
                                [0.6103+0.005, 0.1161, -0.0835+0.005, 0.0195, 0.9992, -0.0010, -0.0352], \
        
        
                                ]
        
        self.GridForRightArm =[ [0.4019+0.01, -0.0972, -0.0746, -0.0221, 0.9997, 0.0069, -0.0032], \
                                [0.5125, -0.0957, -0.0741, -0.0178, 0.9996, 0.0053, -0.0213], \
                                [0.6169, -0.0947+0.005, -0.0760-0.003, -0.0172, 0.9996, -0.0009, 0.0209], \
                                [0.3964,  0.0073+0.005, -0.0801, -0.0174, 0.9998, -0.0050, -0.0050], \
                                [0.5020, 0.0090+0.005, -0.0802, -0.0068, 0.9998, -0.0050, 0.0195], \
                                [0.6169, 0.0147+0.005, -0.0764, -0.0059, 0.9999, 0.0022, -0.0015], \
                                [0.3948, 0.1160+0.01, -0.0815+0.005, -0.0070, 0.9998, -0.0034, -0.0180], \
                                [0.5042, 0.1188+0.008, -0.0818, -0.0058, 0.9999, -0.0073, 0.0087], \
                                [0.6150, 0.1181+0.01, -0.0811+0.005, -0.0235, 0.9995, -0.0124, 0.0146] ]
